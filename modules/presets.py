...
# ChatGPT 设置
INITIAL_SYSTEM_PROMPT = "You are ChatGPT, a large language model trained by OpenAI. Carefully heed the user's instructions. Respond using markdown."
...
CHUANHU_DESCRIPTION = i18n("Integrating Web Search on ChatGPT")
